/*Write a program to input marks of five subjects by the user. Now calculate sum and percentage of the marks.
 Find the grade according to following: a. Percentage >= 90% : Grade A b. Percentage >= 80% : Grade B c. Percentage >= 70% : Grade C 
		 d. Percentage >= 60% : Grade D e. Percentage >= 40% : Grade E f. Percentage < 40% : Grade F*/
